        ...
        >
            <Grid key={index} container style={{ display: 'flex', position: 'relative', zIndex: 99, width: '100%', alignItems: 'center', margin: "20px 0px", justifyContent: 'space-between' }}>
                <Grid item sm={6} xs={12} style={{ zIndex: 99, maxWidth: 360, padding: 15, }}>
                    ...
                    <p
                        style={{
                            color: 'rgba(270, 270, 270, 0.8)', fontSize: 15,
                            marginBottom: 10, marginTop: 10,
                            padding: 25, lineHeight: 1.5, background: txt.background,
                            borderRadius: '4px'
                        }}>{txt.text}</p>
                    <p style={{ fontSize: 13, marginBottom: 10, marginTop: 10, color: '#8892b0', lineHeight: 1.5, width: '90%' }}> <strong>Tech Stack:</strong> {txt.stack}</p>
